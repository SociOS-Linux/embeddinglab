...
def main() -> int:
    ...
    carry = {
        ...
        "carryId": "urn:srcos:model-carry:functional-service:embeddinglab-holmes-pilot",
        "displayName": "EmbeddingLab Holmes Pilot Carry Profile",
        "service": {
            "id": service["id"],
            "ownerRepository": service["ownerRepository"],
            "function": manifest["function"],
            "manifestRef": "SociOS-Linux/embeddinglab:manifests/functional-service.json"
        },
        "sourceos": {
        ...
        "runtime": {
            ...
            "launchProfileRef": "urn:srcos:launch-profile:embeddinglab-holmes-pilot:disabled-v0",
        ...
        "evidence": {
            ...
            "smokeReceiptRef": "SociOS-Linux/embeddinglab:evidence/smoke-receipt.example.json"
        },
        "integrations": {
